...
_ACTION_TOKEN_MAX = 153984 # here only for fast_tokenizer, see Lara/model/modules/vlm/tools/add_qwen_special_tokens/README.md
...
class _QWen3_VL_Interface(nn.Module):
    ...
    def build_qwenvl_inputs(self, images, instructions, solutions=None, prompt_replace_dict=None, prompt_template=None, **kwargs):
        ...
        if solutions is not None: #  here only for fast_tokenizer now. 
            ...
            action_token_max = _ACTION_TOKEN_MAX # here only for fast_tokenizer, see Lara/model/modules/vlm/tools/add_qwen_special_tokens/README.md
            ...
            for i in range(labels.size(0)):
                ...
                if nonzero_indices.numel() > 0:
                    ...
                    seq[:] = IGNORE_INDEX
                    RuntimeWarning (f"action token are on in yout tokenizer, plz see Lara/model/modules/vlm/tools/add_qwen_special_tokens/README.md.")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_yaml", type=str, default="./scripts/config/lara_robot_ft.yaml", help="Path to YAML config")
