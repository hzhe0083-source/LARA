...
from Lara.dataloader.gr00t_lerobot.datasets import ModalityConfig
from Lara.dataloader.gr00t_lerobot.transform.base import ComposedModalityTransform, ModalityTransform
from Lara.dataloader.gr00t_lerobot.transform.concat import ConcatTransform
from Lara.dataloader.gr00t_lerobot.transform.state_action import (
    StateActionSinCosTransform,
    StateActionToTensor,
    StateActionTransform,
)
from Lara.dataloader.gr00t_lerobot.transform.video import (
    VideoColorJitter,
    VideoCrop,
    VideoResize,
    VideoToNumpy,
...
@dataclass
class SO101SingleArmDataConfig:
    video_keys = [
        "video.image_0",
        "video.image_1",
        "video.image_2",
...
ROBOT_TYPE_CONFIG_MAP = {
    ...
    "so101": SO101SingleArmDataConfig,
    "so101_single_arm": SO101SingleArmDataConfig,
