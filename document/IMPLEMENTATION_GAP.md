...
- Stage-2 MoE/router code was added behind `use_lara_moe`; it now has a torch shape test for resident-pool and chunk top-k routing, but it is not yet validated in a full training run.
