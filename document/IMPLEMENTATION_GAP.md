...
- Full `Lara` model instantiation with real Qwen/V-JEPA checkpoints and one-step training smoke tests still need to be run; framework glue is covered by a checkpoint-free fake-component smoke test.
