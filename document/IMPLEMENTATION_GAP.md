...
- `scripts/audit_lara_paper_readiness.py` now audits baseline-safe defaults, SO101 horizon/config contracts, counterfactual utility sidecars, closed-loop rollout protocol evidence, full SO101 training artifacts, and real robot evaluation artifacts. It intentionally reports the repo as not paper-ready while those required artifacts are missing.
